...
pub use db::{
    ...
    classpath_libraries, enable_persistent_stub_cache, file_item_tree, file_symbols, fqn_resolve,
    jdk_builtin_libraries, library_name_index, module_record, project_graph, prune_stub_cache,
