...
pub use db::{
    ...
    enable_persistent_stub_cache, file_body_tree, file_docs, file_facade_source, file_item_tree,
    file_name, file_package_dir, file_path_segments, file_symbols, fqn_resolve, item_doc,
    jdk_builtin_libraries, language_level_for_file, library_name_index, module_record,
