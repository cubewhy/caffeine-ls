...
use crate::{
    java::method::{
        InvocationContext, is_accessible, is_kotlin, member_accessible, mode_allows,
        self_type_param_indexes, source_class_fields, source_class_methods,
    },
    java::resolve::item_data,
