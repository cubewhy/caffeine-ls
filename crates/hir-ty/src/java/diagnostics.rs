...
//! as a structured [`TypeError`] keyed to the body IR it occurred in. The
...
//!
//! Detection only: the *presentation* of a [`TypeError`] — the stable
//! [`syntax::DiagnosticCode`] it carries, its user-facing message and its
//! secondary detail — belongs to `ide-diagnostics`, which also owns the lint
//! vocabulary and the `@SuppressWarnings` scopes.
